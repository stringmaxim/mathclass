...
<head>
    ...
    <title>Valerio's Math Class | Math Analysis</title><!-- Bootstrap Core CSS -->
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="index.php">Home</a></li>
             <li class="active"> <a href="/mathanalysis.php">Math Analysis</a></li>
			 <li><a href="statistics.php">AP Statistics</a></li>
...
<body>
<div class="container">
<center> <h1>Math Analysis Homework List</h1> </center>
...
<div class="row">
  <div class="col-sm-6 col-md-4">
    <div class="thumbnail">
      <img src="http://i.imgur.com/CU2kddY.png" alt="Purple Math">
      <div class="caption">
        <center>  <h3>Purple Math</h3>
        <p>Purple Math provides students helps students with lessons by providing examples!</p>
