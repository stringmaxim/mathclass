...
<head>
    ...
    <title>Dashboard</title><!-- Bootstrap Core CSS -->
...
<form action="login.php" method="post">
                    <div style="margin-bottom: 25px" class="input-group">
                        ...
                        <input id="login-username" type="text" class="form-control" name="username" value="<?php echo $submitted_username; ?>" placeholder="Username">
                    </div>
