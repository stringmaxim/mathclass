<?php 
  ...
  Page is already in use!
        ...
        header("Location: chomeworklist.php"); 
         
        // Calling die or exit after performing a redirect using the header function 
        // is critical.  The rest of your PHP script will continue to execute and 
        // will be sent to the user if you do not die or exit. 
        die("Redirecting to chomeworklist.php"); 
    } 
...
<head>
    ...
    <title>Add Calculus Homework</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title">Add Calculus Homework</div>
            </div>
...
<form action="insertchomework.php" method="post"> 
